import { ILabelSharedProps, Label } from "atoms";

interface IInputLabelProps extends ILabelSharedProps {
	htmlFor: string;
}

interface IInputLabelExpansion {
...
export type { IInputLabelProps, IInputLabelExpansion };
